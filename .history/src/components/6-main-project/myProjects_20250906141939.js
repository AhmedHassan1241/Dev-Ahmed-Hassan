...
Technologies: [
   "React: For building interactive user interfaces.",
    ...
    purpose: [
      "To demonstrate advanced front-end development skills.","To practice building interactive user experiences with third-party API integration.","To create a functional application showcasing user authentication and CRUD operations."],

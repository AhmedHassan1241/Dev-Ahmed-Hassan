        ...
        <div className="flex flex-col items-center gap-6">
          ...
          >
            ...
            <div className="flex flex-col leading-tight">
              ...
              <span className="text-[10px] font-semibold tracking-[0.18em] uppercase text-laravel/80">Mid-Level PHP Backend Developer</span>
            </div>
          </motion.div>
          ...
          >
            ...
            <span className="text-slate-300 text-xs font-medium">Mid-Level PHP Backend Developer</span>
          </motion.div>
